execute as @e[tag=arrow_target] at @s run summon area_effect_cloud ~ ~10 ~ {Tags:["CloudMarker"], Duration:20, Radius:0f}
...
execute as @e[tag=arrow_target] run damage @s 2 minecraft:magic by @p
