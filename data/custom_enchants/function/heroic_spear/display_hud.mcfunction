...
execute if score @s kill_count matches 20.. run scoreboard players set @s storm_arrow_ready 1
execute if score @s kill_count matches ..19 run scoreboard players set @s storm_arrow_ready 0

# --- AFFICHAGE FINAL COMBINÉ ---
# Cas 1 : Rien n'est prêt
execute if score @s combo_ready matches 0 if score @s storm_arrow_ready matches 0 run title @s actionbar ["",{"text":"Coups: ","color":"gray"},{"score":{"name":"@s","objective":"hit_count_spear"},"color":"white"},{"text":"/5  |  ","color":"dark_gray"},{"text":"Victimes: ","color":"gray"},{"score":{"name":"@s","objective":"kill_count"},"color":"white"},{"text":"/20","color":"white"}]

# Cas 2 : Mêlée prête seulement
execute if score @s combo_ready matches 1 if score @s storm_arrow_ready matches 0 run title @s actionbar ["",{"text":"⚡ RAGE PRÊTE","color":"aqua","bold":true},{"text":"  |  ","color":"dark_gray"},{"text":"Victimes: ","color":"gray"},{"score":{"name":"@s","objective":"kill_count"},"color":"white"},{"text":"/20","color":"white"}]
