...
execute store result score #count soul_charges if entity @e[distance=0.1..5,type=!player]
...
execute if score #count soul_charges matches 1..3 run effect give @p minecraft:instant_health 1 0 true

# Cas B : Plus de 3 ennemis -> Instant Health II (4 cœurs)
execute if score #count soul_charges matches 4.. run effect give @p minecraft:instant_health 1 1 true
